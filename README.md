...
This project targets Minecraft **1.21.11**, uses the official Fabric Loom remap plugin and Mojang mappings, Fabric API 0.141.6, Fabric Loader 0.19.5, Java 21, and a compile-only Mod Menu 17 integration.
